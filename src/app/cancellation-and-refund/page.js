...
export default function CancellationAndRefundPage() {
  return (
    <div className="min-h-screen bg-[#FDF8F0]">
      {/* Header */}
      <header className="border-b border-[#D4A843]/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            />
            <h1 className="font-serif text-xl sm:text-2xl text-accent">SNGS Matrimonial</h1>
          </Link>
          <Link href="/">
            <Button variant="ghost" className="font-sans text-secondary hover:text-secondary/80">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="font-serif text-3xl sm:text-4xl text-secondary mb-2">
          Cancellation and Refund Policy
        </h1>
        <p className="font-sans text-sm text-[#2C3E50]/60 mb-8">
        ...
        <div className="space-y-8">
          {/* Introduction */}
          <section>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* Cancellation Policy */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">1. Cancellation Policy</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-sans font-semibold text-[#1A1A1A] mb-2">How to Cancel Your Membership</h3>
                <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
                  You can cancel your premium membership at any time through the following methods:
                </p>
                <ul className="list-disc list-inside font-sans text-[#2C3E50]/80 mt-2 space-y-1 ml-4">
                  <li>Log in to your account and navigate to Settings → Membership → Cancel Membership</li>
                  <li>Send an email to contact@sngsmatrimony.com with subject &quot;Membership Cancellation Request&quot;</li>
                  <li>Contact our customer support at +91-XXXXXXXXXX</li>
                </ul>
              </div>
              <div>
                <h3 className="font-sans font-semibold text-[#1A1A1A] mb-2">Cancellation Processing</h3>
                <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* Refund Eligibility */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">2. Refund Eligibility</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
              Refunds are available under the following conditions:
            </p>
            <div className="bg-[#E3F1E4] border border-[#2E7D32]/25 p-4 rounded-lg mb-4">
              <h3 className="font-sans font-semibold text-[#1E5B22] mb-2">Eligible for Full Refund</h3>
              <ul className="list-disc list-inside font-sans text-[#2E7D32] space-y-1 ml-4">
            ...
            <div className="bg-[#F5E6C3]/50 border border-[#D4A843]/30 p-4 rounded-lg mb-4">
              <h3 className="font-sans font-semibold text-[#8A6215] mb-2">Eligible for Partial Refund (Pro-rated)</h3>
              <ul className="list-disc list-inside font-sans text-[#B8860B] space-y-1 ml-4">
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">3. Non-Refundable Items</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
              The following are not eligible for refund:
            </p>
            <div className="bg-[#FBEAE5] border border-[#E8B4A0] p-4 rounded-lg">
              <ul className="list-disc list-inside font-sans text-[#C75B39] space-y-2 ml-4">
          ...
          {/* Refund Process */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">4. Refund Process</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-sans font-semibold text-[#1A1A1A] mb-2">How to Request a Refund</h3>
                <ol className="list-decimal list-inside font-sans text-[#2C3E50]/80 space-y-2 ml-4">
                  <li>Send an email to contact@sngsmatrimony.com with subject &quot;Refund Request&quot;</li>
              ...
              <div>
                <h3 className="font-sans font-semibold text-[#1A1A1A] mb-2">Refund Timeline</h3>
                <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
                ...
                <p className="font-sans text-[#2C3E50]/80 leading-relaxed mt-2">
          ...
          {/* Refund Method */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">5. Refund Method</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">6. Partial Refund Calculation</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
              For eligible partial refunds, the refund amount is calculated as follows:
            </p>
            <div className="bg-[#F5E6C3]/30 p-4 rounded-lg font-sans text-[#2C3E50]/80">
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">7. Special Circumstances</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
            ...
            <ul className="list-disc list-inside font-sans text-[#2C3E50]/80 space-y-2 ml-4">
            ...
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mt-3">
          ...
          {/* Contact for Refunds */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">8. Contact Us for Refunds</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
              For all cancellation and refund inquiries, please contact us:
            </p>
            <div className="bg-[#F5E6C3]/30 p-4 rounded-lg font-sans text-[#2C3E50]/80">
              <p><strong>SNGS Matrimonial Support Team</strong></p>
              <p>Email: contact@sngsmatrimony.com</p>
          ...
          {/* Policy Changes */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">9. Changes to This Policy</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="border-t border-[#D4A843]/15 py-8 mt-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="font-sans text-sm text-[#2C3E50]/60 text-center">
            Last updated: January 2026
          </p>
          <div className="flex flex-wrap justify-center gap-4 mt-4">
            <Link href="/privacy-policy" className="font-sans text-sm text-secondary hover:text-accent transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms-and-conditions" className="font-sans text-sm text-secondary hover:text-accent transition-colors">
              Terms and Conditions
            </Link>
            <Link href="/shipping-and-delivery" className="font-sans text-sm text-secondary hover:text-accent transition-colors">
              Shipping & Delivery
            </Link>
          </div>
        </div>
