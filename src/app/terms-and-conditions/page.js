    ...
    <div className="min-h-screen bg-[#FDF8F0]">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-8">
          ...
          {/* Acceptance of Terms */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">1. Acceptance of Terms</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* Eligibility */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">2. Eligibility</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">3. Account Registration & Verification</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">4. Membership Plans & Payments</h2>
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-sans font-semibold text-[#1A1A1A] mb-2">Payment Terms:</h3>
                <ul className="list-disc list-inside font-sans text-[#2C3E50]/80 space-y-2 ml-4">
              ...
              <div>
                <h3 className="font-sans font-semibold text-[#1A1A1A] mb-2">Auto-Renewal:</h3>
                <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* User Conduct */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">5. User Conduct & Prohibited Activities</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
            ...
            <ul className="list-disc list-inside font-sans text-[#2C3E50]/80 space-y-2 ml-4">
              ...
              <li>Use any automated tool, bot, or script to collect, scrape, or bulk-download member profiles, photos, or contact details</li>
              <li>Copy, resell, redistribute, or otherwise commercially exploit member profiles or photos obtained through the platform, including for offline matchmaking or brokering services</li>
            ...
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mt-3">
              Violating these data-use restrictions is treated as a serious breach of these Terms and may result in immediate suspension or termination of your account without refund, in addition to any other legal remedies available to us.
            </p>
          </section>

          {/* Content Guidelines */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">6. Content Guidelines</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">7. Intellectual Property</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">8. Limitation of Liability</h2>
          ...
          {/* Termination */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">9. Termination</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
          ...
          {/* Governing Law */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">10. Governing Law</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* Dispute Resolution */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">11. Dispute Resolution</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* Changes to Terms */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">12. Changes to Terms</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed">
          ...
          {/* Contact Information */}
          <section>
            <h2 className="font-serif text-xl text-secondary mb-4">13. Contact Us</h2>
            <p className="font-sans text-[#2C3E50]/80 leading-relaxed mb-3">
      ...
      <footer className="border-t border-[#D4A843]/15 py-8 mt-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4">
            ...
            <Link href="/cancellation-and-refund" className="font-sans text-sm text-secondary hover:text-accent transition-colors">
              Cancellation & Refund
            </Link>
