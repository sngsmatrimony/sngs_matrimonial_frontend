      ...
      <SheetPrimitive.Content
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-full p-1.5 text-[#2C3E50]/60 hover:bg-[#F5E6C3]/60 hover:text-[#1A1A1A] transition-colors focus:outline-none disabled:pointer-events-none">
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("font-serif text-lg font-semibold text-[#1A1A1A]", className)}
      {...props} />
  );
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("font-sans text-sm text-[#2C3E50]/70", className)}
      {...props} />
  );
}
